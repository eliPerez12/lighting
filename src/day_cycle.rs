...
impl DayCycle {
    ...
    pub fn get_ambient_light(&self) -> Light {
        ...
        let final_color = {
            ...
            } else if (SUNSET - SUNRISE_LENGTH..SUNSET).contains(&normilized_time) {
